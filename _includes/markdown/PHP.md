...
<h3 id="security" class="anchor-heading">Security {% include Util/top %}</h3>
...
<h3 id="unit-testing" class="anchor-heading">Unit and Integration Testing {% include Util/top %}</h3>
...
<h3 id="libraries" class="anchor-heading">Libraries and Frameworks {% include Util/top %}</h3>
...
<h3 id="avoid-heredoc-nowdoc" class="anchor-heading">Avoid Heredoc and Nowdoc {% include Util/top %}</h3>
