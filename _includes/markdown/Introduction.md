<h3 id="audience" class="anchor-heading">Audience</h3>
...
<h3 id="goal" class="anchor-heading">Goal {% include Util/top %}</h3>
...
<h3 id="philosophy" class="anchor-heading">Philosophy {% include Util/top %}</h3>
...
<h3 id="contributing" class="anchor-heading">Contributing {% include Util/top %}</h3>
