...
<h3 id="local-development" class="anchor-heading">Local Development Environments {% include Util/top %}</h3>
...
<h3 id="task-runners" class="anchor-heading">Task Runners {% include Util/top %}</h3>
...
<h3 id="package-managers" class="anchor-heading">Package/Dependency Managers {% include Util/top %}</h3>
...
<h3 id="version-control" class="anchor-heading">Version Control {% include Util/top %}</h3>
...
<h3 id="command-line" class="anchor-heading">Command Line Tools {% include Util/top %}</h3>
