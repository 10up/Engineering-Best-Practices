<h3 id="philosophy" class="anchor-heading">Philosophy</h3>
...
<h3 id="syntax-formatting" class="anchor-heading">Syntax and Formatting {% include Util/top %}</h3>
...
<h3 id="documentation" class="anchor-heading">Documentation {% include Util/top %}</h3>
...
<h3 id="performance" class="anchor-heading">Performance {% include Util/top %}</h3>
...
<h3 id="responsive-websites" class="anchor-heading">Responsive websites {% include Util/top %}</h3>
...
<h3 id="frameworks" class="anchor-heading">Frameworks {% include Util/top %}</h3>
